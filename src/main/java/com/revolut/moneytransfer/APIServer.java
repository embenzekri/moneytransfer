        ...
        OpenAPI3RouterFactory.create(
                ...
                ar -> {
                    if (ar.succeeded()) {
                        ...
                        factory.addHandlerByOperationId(
                                "createTransfer", transferAPIController::createTransfer);
                        factory.addHandlerByOperationId(
                                "executeTransfer", transferAPIController::executeTransfer);
                        factory.addHandlerByOperationId(
                                "cancelTransfer", transferAPIController::cancelTransfer);
